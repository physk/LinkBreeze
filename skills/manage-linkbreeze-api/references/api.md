...
Base path: `/api/v1`. Authenticate all resource requests with `Authorization: Bearer <key>`. Retrieve the machine-readable OpenAPI 3.1 document from `/api/v1/openapi.json`.
